...
class CreateCustomerTest extends TestCase
{
    ...
    public function it_should_create_an_create_customer_instance(){
        ...
        $this->assertInstanceOf(CreateCustomer::class, $createCustomerRequest);
    ...
    public function it_should_fill_instance_with_values(){
        ...
        $createCustomerRequest->setNotes($data['notes']);
        ...
        $createCustomerRequest->setInsertEnrollerTree($data['insertEnrollerTree']);
        $createCustomerRequest->setEnrollerID($data['enrollerID']);
        $createCustomerRequest->setInsertUnilevelTree($data['insertUnilevelTree']);
        $createCustomerRequest->setSponsorID($data['sponsorID']);
        $createCustomerRequest->setUseManualCustomerID($data['useManualCustomerID']);
        $createCustomerRequest->setManualCustomerID($data['manualCustomerID']);
        ...
        $createCustomerRequest->setEntryDate($data['entryDate']);
        ...
        $createCustomerRequest->setTaxIDType($data['taxIDType']);
        ...
        $createCustomerRequest->setSponsorKey($data['sponsorKey']);
        $createCustomerRequest->setEnrollerKey($data['enrollerKey']);
        $createCustomerRequest->setManualCustomerKey($data['manualCustomerKey']);
        ...
        $this->assertEquals($data['notes'], $createCustomerRequest->getNotes());
        ...
        $this->assertEquals($data['insertEnrollerTree'], $createCustomerRequest->getInsertEnrollerTree());
        $this->assertEquals($data['enrollerID'], $createCustomerRequest->getEnrollerID());
        $this->assertEquals($data['insertUnilevelTree'], $createCustomerRequest->getInsertUnilevelTree());
        $this->assertEquals($data['sponsorID'], $createCustomerRequest->getSponsorID());
        $this->assertEquals($data['useManualCustomerID'], $createCustomerRequest->getUseManualCustomerID());
        $this->assertEquals($data['manualCustomerID'], $createCustomerRequest->getManualCustomerID());
        ...
        $this->assertEquals($data['entryDate'], $createCustomerRequest->getEntryDate());
        ...
        $this->assertEquals($data['taxIDType'], $createCustomerRequest->getTaxIDType());
        ...
        $this->assertEquals($data['sponsorKey'], $createCustomerRequest->getSponsorKey());
        $this->assertEquals($data['enrollerKey'], $createCustomerRequest->getEnrollerKey());
        $this->assertEquals($data['manualCustomerKey'], $createCustomerRequest->getManualCustomerKey());
    ...
    public function it_should_create_a_customer(){
        ...
        $this->assertNotNull($response->data->customerID);
